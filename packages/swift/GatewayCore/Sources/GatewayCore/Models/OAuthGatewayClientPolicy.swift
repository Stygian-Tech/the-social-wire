...
public struct OAuthGatewayClientPolicy: Sendable {
  public let allowedClientIds: Set<String>
  public let allowedAudiences: Set<String>
  public let requireKnownClient: Bool

  public init(allowedClientIds: Set<String>, allowedAudiences: Set<String>, requireKnownClient: Bool) {
    self.allowedClientIds = allowedClientIds
    self.allowedAudiences = allowedAudiences
    self.requireKnownClient = requireKnownClient
  }

  public static let permissive = OAuthGatewayClientPolicy(
    allowedClientIds: [],
    allowedAudiences: [],
    requireKnownClient: false
  )

  public func assertAllowedJWTClient(
...
public enum OAuthGatewayPolicyParser {
  public static func delimiterTokenSet(_ raw: String?) -> Set<String> {
