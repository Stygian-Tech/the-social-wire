...
const mirrors = [
  ...
  ["link.latr.bookmarks.listTags.json", "../link/latr/bookmarks/listTags.json"],
  ...
  ["link.latr.bookmarks.setTags.json", "../link/latr/bookmarks/setTags.json"],
  ["link.latr.bookmarks.renameTag.json", "../link/latr/bookmarks/renameTag.json"],
  ["link.latr.bookmarks.deleteTag.json", "../link/latr/bookmarks/deleteTag.json"],
