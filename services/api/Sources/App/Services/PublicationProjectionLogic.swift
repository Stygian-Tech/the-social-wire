...
// MARK: - Collection constants (mirror web `pdsClient` / `atprotoClient`)

enum PublicationLexicons {
  static let folder = "com.thesocialwire.folder"
  static let publicationPrefs = "com.thesocialwire.publicationPrefs"
  static let graphSubscription = "site.standard.graph.subscription"
  static let skyreaderFeedSubscription = "app.skyreader.feed.subscription"
  static let graphFollow = "app.bsky.graph.follow"
  ...
  static let discoveryPublicationCollections = [
    "site.standard.publication",
    "com.standard.publication",
    "app.offprint.publication",
  ]

  static let discoveryContentCollections = [
  ...
  static let rssAuthorDid = "did:web:skyreader.rss"
  static let rssPublicationPrefix = "rss:"
}
