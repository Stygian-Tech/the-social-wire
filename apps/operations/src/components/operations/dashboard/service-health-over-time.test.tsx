...
test("renders grouped rolling service-health dimensions and keeps hard evidence separate", () => {
  ...
  expect(screen.getAllByText("Required Services Liveness").length).toBeGreaterThanOrEqual(2)
  expect(screen.getAllByText("Required Services Readiness").length).toBeGreaterThanOrEqual(2)
  expect(screen.getAllByText("Worker Freshness").length).toBeGreaterThanOrEqual(2)
  expect(screen.getAllByText("Worker Completeness").length).toBeGreaterThanOrEqual(2)
